...
const communicationOptions = [
  { id: "objetiva", title: "Objetiva", description: "Informações precisas e focadas.", icon: Target },
  { id: "conectiva", title: "Conectiva", description: "Descoberta de relações e padrões ocultos.", icon: Cable },
  { id: "exploratoria", title: "Exploratória", description: "Insights detalhados e contextualizados.", icon: Compass },
  { id: "resumida", title: "Resumida", description: "Síntese clara e acionável.", icon: FileText },
];
