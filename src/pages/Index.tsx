...
const Index = () => {
  ...
  return <div className="min-h-screen flex bg-white relative">
      ...
      <div className="w-[60px] bg-[hsl(var(--smartshelf-blue))] flex flex-col justify-between items-center py-6">
        ...
        <div className="pb-8">
          <button onClick={logout} className="text-white hover:opacity-75 transition-opacity duration-200 group relative" title={sidebarIcons[sidebarIcons.length - 1].label}>
